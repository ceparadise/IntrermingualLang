...
def main():
    ...
    input_doc_stream = open(train_docs_path_en, 'r', encoding='utf8')
    train_docs_en = [];
    ...
    input_doc_stream = open(train_docs_path_cn, 'r', encoding='utf8')
    train_docs_cn = [];
    for line in input_doc_stream:
    ...
    input_voc_stream = open(vocabulary_path_en, 'r', encoding='utf8');
    vocab_en = []
    ...
    input_voc_stream = open(vocabulary_path_cn, 'r', encoding='utf8');
    vocab_cn = []
    for line in input_voc_stream:
