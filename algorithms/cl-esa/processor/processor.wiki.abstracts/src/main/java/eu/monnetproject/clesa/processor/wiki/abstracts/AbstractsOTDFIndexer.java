...
public class AbstractsOTDFIndexer {
    ...
    private void loadConfig() {
        try {
            config.load(new FileInputStream("processor/processor.wiki.abstracts/load/eu.monnetproject.clesa.processor.wiki.abstracts.AbstractsOTDFIndexer.properties"));
